...
function writeResumeTitle() {
	return '<br><br><div class="resDivTitle card" onclick="listForOpenSesame()" style="max-width:975px;background-color: white; text-align: left;"><h2><gara><strong><div id="resTitle">Jared Raiola ▼</div></strong></gara></h2><p>jraiola3@gatech.edu ✦ (845) 490-7692 ✦ Mahopac, New York</p></div>'
}

function writeObjective() {
	return '<div id="resObj" class="resDiv card" onclick=openSesame("objTitle","objBody",600,true); style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;"><p><strong><div id="objTitle">OBJECTIVE ▼</div></strong><div id="objBody" style="display: none;"><hr></p><p><strong></strong></p><p>Undergraduate student looking to obtain employment that enables my knowledge of computer science along with use of communication, creativity, and teamwork to help provide a competitive advantage, as well as help provide continued company success</p><p><strong></strong></p></div></div>'
}
function writeWorkExperience() {
	return '<div id="resWork" class="resDiv card" onclick=openSesame("workTitle","workBody",600,true); style="max-width:975px;background-color: white; text-align: left;"><p><strong><div id="workTitle">WORK EXPERIENCE ▼</div></strong><div id="workBody" style="display: none;"><hr></p><p><strong><u></u></strong></p><p><strong>Total Concept Builders Summers 2013 – 2018</strong></p><p><em>General Laborer</em><em> Mahopac, NY</em></p><p>➤ Performed interior and exterior renovations, installed windows, doors, cabinets, worked with team of people, also responsible for transportation and organization of construction materials</p><p><strong>Kobu Asian Bistro May 2015 – June 2017</strong></p><p><em>Waiter</em><em> Mahopac, NY</em></p><p>➤ Coordinated seating, serving, interacting with customers, general foodstuff and restaurant goods maintenance and replenishment</p><p><strong></strong></p></div></div>'
}

function writeEducation() {
	return '<div id="resEdu" class="resDiv card" onclick=openSesame("eduTitle","eduBody",600,true); style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;"><p><strong><div id="eduTitle">EDUCATION ▼</div></strong><div id="eduBody" style="display: none;"><hr></p><p><strong></strong></p><p><strong>Georgia Institute of Technology May, 2021 </strong></p><p><em>BS, Computer Science Sophomore Atlanta, GA</em></p><p>➤ Delta Upsilon Fraternity Assistant House Manager</p><p><strong>Mahopac National Honor Society, Top 10% June 2017 </strong><strong></strong></p></div></div>'
}

function writeLeadershipExperience() {
	return '<div id="resLead" class="resDiv card" onclick=openSesame("leadTitle","leadBody",600,true); style="max-width:975px;background-color: white; text-align: left;"><p><strong><div id="leadTitle">LEADERSHIP EXPERIENCE ▼</div></strong><div id="leadBody" style="display: none;"><hr></p><p><u></u></p><p>➤ <strong>People to People Leadership Ambassador Program (2009-2011)</strong></p><p>    <blockquote>o Volunteer work in various underserved communities, trained to take on leadership role</blockquote></p><p>➤ <strong>Leader of Mahopac High School Sax Quartet</strong></p><p><blockquote>o Managed musical gigs and practice schedules</blockquote></p><p>➤ <strong>Delta Upsilon Fraternity Regional Leadership Academy</strong></p></div></div>'
}

function writeResumeProjects() {
	return '<div id="resProj" class="resDiv card" onclick=openSesame("resProjTitle","resProjBody",600,true); style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;"><p><strong><div id="resProjTitle">PROJECTS ▼</div></strong><div id="resProjBody" style="display: none;"><hr></p><p><u></u></p><p>➤ <strong>8-Bit RPG iOS Application(In Progress):</strong></p><p><blockquote>o Closed World dungeon clearing game with a main storyline written in Swift</blockquote></p><p>➤ <strong>GUI Format Files Program(In Progress):</strong></p><p><blockquote>o Small project, created to help a small construction company format work proposal forms</blockquote></p><p><blockquote>o Written in Python, this program will take user input and calculate labor hours, unit cost, and format it into a word document for easy access and    use</blockquote></p></div></div>'
}

function writeSkillsInterests() {
	return '<div id="resSkill" class="resDiv card" onclick=openSesame("skillTitle","skillBody",600,true); style="max-width:975px;background-color: white; text-align: left;"><p><strong><div id="skillTitle">SKILLS &amp; INTERESTS ▼</div></strong><div id="skillBody" style="display: none;"><hr></p><p><u></u></p><p>➤ <strong> Skills: </strong>Java; C++; Python; Swift; (currently learning) Scala; Microsoft Office; general public</p><p>➤ <strong> Interests:</strong> iOS development; cyber security; video game development; musician; traveling; skiing; hiking; tennis</p><p><strong></strong></p><p><u></u></p></div></div>'
}

function writeFooters() {
	return '<div id="resFoot" class="resDiv card smallfoot" style="max-width:975px;background-color: rgb(245, 245, 245); text-align: center;"><p>LinkedIn:<a href="https://www.linkedin.com/in/jared-raiola/">https://www.linkedin.com/in/jared-raiola/</a>✦ GitHub:<a href="https://github.com/JaredRaiola">https://github.com/JaredRaiola</a>✦ My Website: <a href="http://jaredraiola.me/">http://jaredraiola.me/</a></p></div><div id="resumeButton" class="resFooter"><a href="./Jared-Raiola-Resume.pdf" class="downloadButton" download><i class="fa fa-cloud-download"></i>&nbsp;&nbsp;Click here to download this resume as a PDF!&nbsp;&nbsp;<i class="fa fa-cloud-download"></i></a><br><br><br></div></div>'
}

function listForOpenSesame() {
	var sectionList = ["objBody","workBody", "eduBody", "leadBody", "resProjBody", "skillBody"];
	var tf = true;
	...
	var currHTML = $("#resTitle").html();
	if (tf) {
		var newHTML = currHTML.substring(0, currHTML.length - 1) + "▲";
	} else {
		var newHTML = currHTML.substring(0, currHTML.length - 1) + "▼";
	}
	$("#resTitle").html(newHTML);
	openSesame("objTitle", "objBody", 200, tf);
	openSesame("workTitle", "workBody", 200, tf);
	openSesame("eduTitle", "eduBody", 200, tf);
	openSesame("leadTitle", "leadBody", 200, tf);
	openSesame("resProjTitle", "resProjBody", 200, tf);
	openSesame("skillTitle", "skillBody", 200, tf);
}
...
function openSesame(parentDiv, divToOpen, speed, tf) {
  ...
  if (tf && $(div).is(":hidden")) {
    $(div).slideDown(speed);
    var newHTML = currHTML.substring(0, currHTML.length - 10) + "▲</strong>";
  } else {
    $(div).slideUp(speed);
    var newHTML = currHTML.substring(0, currHTML.length - 10) + "▼</strong>";
  }
