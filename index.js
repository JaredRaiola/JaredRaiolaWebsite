...
function writeEducation() {
	return '<div id="resEdu" class="dropDiv card" style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;"><p><strong><div onclick=openSesame("eduTitle","eduBody",600,true);  id="eduTitle" class="clickable">EDUCATION ▼</div></strong><div id="eduBody" style="display: none;"><hr></p><p><strong></strong></p><p><strong>Georgia Institute of Technology (May 2021) </strong></p><p>➤ <em>BS, Computer Science Junior Atlanta, GA</em></p><p><blockquote>o Delta Upsilon Fraternity Assistant House Manager</blockquote></p><p><strong>Mahopac National Honor Society, Top 10% (June 2017) </strong></p></div></div>'
}

function writeLeadershipExperience() {
	return '<div id="resLead" class="dropDiv card" style="max-width:975px;background-color: white; text-align: left;"><p><strong><div onclick=openSesame("leadTitle","leadBody",600,true); id="leadTitle" class="clickable">LEADERSHIP EXPERIENCE ▼</div></strong><div id="leadBody" style="display: none;"><hr></p><p>➤ <strong>People to People Leadership Ambassador Program (2009-2011)</strong></p><p>    <blockquote>o Volunteer work in various underserved communities, trained to take on leadership role</blockquote></p><p>➤ <strong>Leader of Mahopac High School Sax Quartet</strong></p><p><blockquote>o Managed musical gigs and practice schedules</blockquote></p><p>➤ <strong>Delta Upsilon Fraternity Regional Leadership Academy</strong></p></div></div>'
}

function writeResumeProjects() {
	return '<div id="resProj" class="dropDiv card"  style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;"><p><strong><div onclick=openSesame("resProjTitle","resProjBody",600,true); id="resProjTitle" class="clickable">PROJECTS ▼</div></strong><div id="resProjBody" style="display: none;"><hr></p><p>➤ <strong>8-Bit RPG iOS Application(In Progress):</strong></p><p><blockquote>o Closed World dungeon clearing game with a main storyline written in Swift</blockquote></p><p>➤ <strong>GUI Format Files Program(In Progress):</strong></p><p><blockquote>o Small project, created to help a small construction company format work proposal forms</blockquote></p><p><blockquote>o Written in Python, this program will take user input and calculate labor hours, unit cost, and format it into a word document for easy access and    use</blockquote></p></div></div>'
}
