...
function writeFrontPageTextBody1() {
	return "<div id='bodyText1' class='card roundedDiv' style='background-color: white;'><h3>About Me</h3><p>I am a Senior attending <b>Georgia Institute of Technology</b> majoring in <b>computer science</b>. My hobbies include hiking, skiing, traveling, playing music and playing with dogs! Throughout my life, I've been raised to help others and dedicate myself fully to any project that is at hand. This has led to my participation in leadership programs in Washington D.C.'s People To People, and having performed community service in Boston and New Orleans, rebuilding communities in both areas. Throughout my career at Mahopac High School I've led my school's sax quartet, participated in the jazz and marching bands, created a taco club, and was the captain of the tennis team. In college, I've joined the iOS development club, orgT caving, and Delta Upsilon fraternity. I actively participate in all of these organizations and had previously taken a leadership role in my fraternity as Assistant House Manager. One of my major goals in life is to travel the world, because it's very important to learn about and be appreciative of other cultures and idealogies.Thank you for taking the time to check out my website and learn a little bit more about me! Here you'll find links to my GitHub, LinkedIn, Resume, and my Projects.</p></div>"
}
