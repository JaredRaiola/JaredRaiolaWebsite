...
function writeResumeTitle() {
	return '<br><br><div class="roundedDiv w3-container" style="max-width:975px;background-color: white; text-align: left;"><h2><gara><strong>Jared Raiola</strong></gara></h2>    <p>        jraiola3@gatech.edu <bulletpoint>v</bulletpoint> (845) 490-7692 <bulletpoint>v</bulletpoint> Mahopac, New York	_____________________________________________________________________________________________	</p></div>'
}

function writeObjective() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;">    <p>        <strong>OBJECTIVE</strong>		_____________________________________________________________________________________________    </p><p>    <strong> </strong></p>    <p>        Undergraduate student looking to obtain employment that enables my knowledge of        computer science along with use of communication, creativity, and        teamwork to help provide a competitive advantage, as well as help        provide continued company success    </p>    <p>        <strong></strong>    </p></div>'
}
function writeWorkExperience() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: white; text-align: left;">    <p>        <strong>WORK EXPERIENCE </strong>		_____________________________________________________________________________________________    </p><p>    <strong><u></u></strong></p><p>    <strong>Total Concept Builders Summers 2013 – 2018</strong></p><p>    <em>General Laborer</em>    <em> </em>    <em> Mahopac, NY</em>    <em></em></p><p>    <bulletpoint>§</bulletpoint>  Performed interior and exterior renovations, installed windows, doors,    cabinets, worked with team of people, also responsible for transportation    and organization of construction materials</p><p>    <strong>Kobu Asian Bistro May 2015 – June 2017</strong></p><p>    <em>Waiter</em>    <em> </em>    <em> Mahopac, NY</em></p><p>    <bulletpoint>§</bulletpoint>  Coordinated seating, serving, interacting with customers, general    foodstuff and restaurant goods maintenance and replenishment</p>    <p>        <strong></strong>    </p></div>'
}

function writeEducation() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;">    <p>        <strong>EDUCATION </strong>		_____________________________________________________________________________________________    </p><p>    <strong> </strong></p><p>    <strong>Georgia Institute of Technology May, 2021 </strong></p><p>    <em>BS, Computer Science Sophomore Atlanta, GA</em></p><p>    <bulletpoint>§</bulletpoint>  Delta Upsilon Fraternity Assistant House Manager</p><p>    <strong>Mahopac National Honor Society, Top 10% June 2017 </strong>    <strong></strong></p></div>'
}

function writeLeadershipExperience() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: white; text-align: left;">    <p>        <strong>LEADERSHIP EXPERIENCE</strong>		_____________________________________________________________________________________________    </p><p>    <u></u></p><p>	<bulletpoint>§</bulletpoint>  <strong>People to People Leadership Ambassador Program (2009-2011)</strong></p><p>    <blockquote>o Volunteer work in various underserved communities, trained to take on    leadership role</blockquote></p><p>    <bulletpoint>§</bulletpoint>  <strong>Leader of Mahopac High School Sax Quartet</strong></p><p>    <blockquote>o Managed musical gigs and practice schedules</blockquote></p><p>    <bulletpoint>§</bulletpoint>  <strong>Delta Upsilon Fraternity Regional Leadership Academy</strong></p></div>'
}

function writeResumeProjects() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: rgb(245, 245, 245); text-align: left;">    <p>        <strong>PROJECTS</strong>		_____________________________________________________________________________________________    </p><p>    <u></u></p><p>    <bulletpoint>§</bulletpoint>  <strong>8-Bit RPG iOS Application(In Progress):</strong></p><p>    <blockquote>o Closed World dungeon clearing game with a main storyline written in Swift</blockquote></p><p>    <bulletpoint>§</bulletpoint>  <strong>GUI Format Files Program(In Progress):</strong></p><p>    <blockquote>o Small project, created to help a small construction company format work    proposal forms</blockquote></p><p>    <blockquote>o Written in Python, this program will take user input and calculate labor    hours, unit cost, and format it into a word document for easy access and    use</blockquote></p></div>'
}

function writeSkillsInterests() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: white; text-align: left;">    <p>        <strong>SKILLS &amp; INTERESTS</strong>		_____________________________________________________________________________________________    </p><p>    <u></u></p><p>    <bulletpoint>§</bulletpoint>  <strong> Skills: </strong>Java; C++; Python; Swift; (currently learning)    Scala; Microsoft Office; general public</p><p>    <bulletpoint>§</bulletpoint>  <strong> Interests:</strong> iOS development; cyber security; video game    development; musician; traveling; skiing; hiking; tennis</p><p>    <strong></strong></p><p>    <u></u></p></div>'
}

function writeFooters() {
	return '<div class="roundedDiv w3-container" style="max-width:975px;background-color: rgb(245, 245, 245); text-align: center;"><p><smallfoot>    LinkedIn:    <a href="https://www.linkedin.com/in/jared-raiola/">        https://www.linkedin.com/in/jared-raiola/    </a><bulletpoint>v</bulletpoint> GitHub:    <a href="https://github.com/JaredRaiola">https://github.com/JaredRaiola</a>   <bulletpoint>v</bulletpoint> My Website: <a href="http://jaredraiola.me/">http://jaredraiola.me/</a></smallfoot></p></div><footer><br><button onclick="downloadPDF()" class="downloadButton"><i class="roundedDiv fa fa-cloud-download"></i>Click here to download this resume as a PDF!<i class="roundedDiv fa fa-cloud-download"></i></a><iframe id="invisible" style="display:none;"></iframe></div><br><br><br></footer>'
}